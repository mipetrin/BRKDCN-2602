...
# python deploy_aci_app.py --url https://10.66.80.38 --login admin --prefix mipetrin-CLMEL18 --amount 3
# python deploy_aci_app.py --url https://10.66.80.38 --login admin --prefix mipetrin-CLMEL18 --amount 3 -delete
```
